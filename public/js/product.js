...
document.addEventListener('DOMContentLoaded', function () {
  tambahProduk('http://127.0.0.1:5500/public/assets/Jordan Series ES.jpg', 'Jordan Series ES', '1.399.000');
  tambahProduk("http://127.0.0.1:5500/public/assets/Nike Blazer Low '77 Jumbo.jpg", "Nike Blazer Low '77 Jumbo", '2.199.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Pegasus 40.jpg', 'Nike Pegasus 40', '2.399.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Tanjun Racer Lifestyle Shoes.jpg', 'Nike Tanjun Racer', '1.990.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Jumpman MVP.jpg', 'Jumpman MVP', '1.099.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Jumpman Two Trey.jpg', 'Jumpma Two Grey', '1.799.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Air Max 90.jpg', 'Nike Air Max 90', '1.799.000');
  tambahProduk("http://127.0.0.1:5500/public/assets/Zion 2 'Full Moon' PF.jpg", "Zion 2 'Full Moon", '1.799.000');
  tambahProduk("http://127.0.0.1:5500/public/assets/Nike Air Force 1 '07.jpg", "Nike Air Force '07'", '1.299.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike GT Jump.png', 'Nike GT Jump', '1.799.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike React Phantom Run Flyknit 2.jpg', 'Phantom Run Flyknit 2', '1.799.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/KD Trey 5 X EP.jpg', 'KD Trey 5 X EP ', '1.999.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Jordan Stadium 90.jpg', 'Jordan Stadium 90', '1.499.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Jordan Stay Loyal 2.png', 'Jordan Stay Loyal', '1.799.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike ACG Watercat+.png', 'Nike ACG Watercat', '2.299.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Air Flight Lite Mid.png', 'Nike Air Flight Lite Mid', '2.199.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Cosmic Unity 2.png', 'Nike Cosmic Unity 2', '2.099.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Dunk High Retro Premium.png', 'Nike Dunk High Retro Premium', '1.699.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Elevate 3.png', 'Nike Elevate 3', '1.999.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Go FlyEase.png', 'Nike Go FlyEase', '1.999.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Killshot 2 Leather.png', 'Nike KillShot 2 Leather', '2.009.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Tech Hera.png', 'Nike Tech Hera', '1.699.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Tempo.png', 'Nike Tempo', '2.199.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Vomero 16.png', 'Nike Vomero 16', '1.599.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike SuperRep Go.jpg', 'Nike SuperPrep Go', '1.099.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Impact 4.jpg', 'Nike Impact 4', '1.349.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Air Jordan 1 Mid.jpg', 'Air Jordan 1 Mid', '1.939.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Air VaporMax 2023 Flyknit.jpg', 'Nike Air VaporMax 2023 FlyNit', '3.269.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Air Max Plus 3.jpg', 'Nike Air Max Plus 3', '2.989.000');
  tambahProduk('http://127.0.0.1:5500/public/assets/Nike Air Presto.jpg', 'Nike Air Presto', '2.199.000');
});
...
function tambahProduk(sourceImg, namaProduk, hargaProduk) {
  ...
  console.log('Image Source:', sourceImg);
  ...
  buttonAddToCart.addEventListener('click', function () {
    ...
    let sourceImg = document
      .getElementById('produk-' + idCard)
